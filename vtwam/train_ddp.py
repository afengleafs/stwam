"""Distributed VTWAM training on local LIBERO."""
...
from .train_libero import _make_config, _require_vae_dir, _require_vtwam_imports
...
def _child_args(args, candidate: int) -> list[str]:
    child = [
        ...
        "--vae-model-dir", args.vae_model_dir,
